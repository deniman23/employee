...
import org.example.services.service.EmployeeServiceDao;
...
public class EmployeeConsoleService {
    ...
    public EmployeeConsoleService(EmployeeService employeeService, JsonMapper jsonMapper, EmployeeMenu employeeMenu) {
