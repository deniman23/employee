...
public class PostController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> createPost(@RequestBody RequestPost requestPost) {
        Optional<PostDto> createdPost = Optional.ofNullable(postAPI.createPost(requestPost));
        return createdPost
    ...
    public ResponseEntity<?> changePost(@PathVariable int id, @RequestBody RequestPost requestPost) {
        requestPost.setId(id);
        Optional<Post> updatedPost = postAPI.changePost(requestPost);
        return updatedPost
