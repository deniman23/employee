...
public class EmployeeConsoleService {
    ...
    public void outputAllEmployeesSortedByLastNameConsole() {
        ...
        if (employeeDtos.isEmpty()) {
            ...
            employeeDtos.forEach(employeeDto -> {
                try {
                    System.out.println(jsonMapper.convertEmployeeToJson(employeeDto, employeeAPI.outputTerminatedEmployees().getPostDtos()));
    ...
    public void outputEmployeeConsole() {
        ...
        try {
            ...
            List<EmployeeDto> employeeDtos = searchResult.getEmployeeDtos();
            if (!employeeDtos.isEmpty()) {
                for (EmployeeDto employeeDto : employeeDtos) {
                    try {
                        String employeeJson = jsonMapper.convertEmployeeToJson(employeeDto, searchResult.getPostDtos());
