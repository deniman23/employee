...
public class EmployeeMenu extends EmployeeAPI {
    ...
    public static void menuEmployee(Map<String, Employee> employees, Map<String, Post> posts) {
            ...
            while (isRunning) {
                ...
                switch (operator) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        //outputEmployee(scanner, employees);
                        break;
                    case 6:
                        //outputEmployeesByFilter(scanner, employees);
                        break;
                    case 7:
                        isRunning = false;
